...
public class InternationalScheduledPayment extends RestAPIRequest{
	...
	/**
	 * This method is for constructing an empty International Scheduled Payment with default settings
	 */
	private InternationalScheduledPayment(){
		setTestData();
	}
	
	public void setTestData(){
		_idempotancyKey=PropertyUtils.getProperty("idempotency_key")+"."+Misc.generateString(4);
		setDescription("Create International Scheduled Payment Consent");
		...
		_requestedExecutionDateTime = "2020-08-06T06:06:06.666+00:00";
		...
		private static class InnerInternationalScheduledPayment{
			private static InternationalScheduledPayment isp;
			public static InternationalScheduledPayment createInstance(){
				if(isp==null){
					isp=new InternationalScheduledPayment();
				}
				return isp;
			}
		}
		
		public static InternationalScheduledPayment getInstance(){
			return InnerInternationalScheduledPayment.createInstance();
		}
		...
		public void setInstructionIdentification(String instructionIdentification){
			_instructionIdentification = instructionIdentification;
		}
		...
		public void setEndToEndIdentification(String endToEndIdentification){
			_endToEndIdentification = endToEndIdentification;
		}
		...
		public void setLocalInstrument(String localInstrument){
			_localInstrument = localInstrument;
		}
		
		/**
		 *  This method is for setting Instruction Priority for REST Request
		 */
		public void setInstructionPriority(String instructionPriority)
		{
			_instructionPriority = instructionPriority;
		}
		...
		public void setRequestedExecutionDateTime(String requestedExecutionDateTime){
			_requestedExecutionDateTime = requestedExecutionDateTime;
		}
		...
		/**
		 * This method is for setting AppliedAuthenticationApproach for REST request
		 */	
		...
		/**
		 * This method is for removing creditor Agent postal Address for REST request
		 */	
		...
		/**
		 * This method is for removing Authorization for REST request
		 */	
			...
			if(!removeInitiation){
				_reqBody = _reqBody + "\"Initiation\": {"
						...
						if(_baseURL.contains("consents")){
							...
							setDescription("Create International Scheduled Payments");
		...
		public String getPaymentId() {
			return getResponseNodeStringByPath("Data.InternationalScheduledPaymentId");
	}
}