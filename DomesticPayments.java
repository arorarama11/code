...
public class DomesticPayments extends RestAPIRequest{
	...
	public void setTestData(){
		...
		private static class InnerDomesticPayments{
			private static DomesticPayments dp;
			public static DomesticPayments createInstance(){
				if(dp==null){
					dp=new DomesticPayments();
				}
				return dp;
			}
		}
		
		public static DomesticPayments getInstance(){
			return InnerDomesticPayments.createInstance();
		}
		...
		public String genRequestBody(){
					...
					if(!removeInitiation){
							...
							if(_baseurl.contains("consents")){
								setDescription("Create Domestic Payment Consents ");
								...
								setDescription("Create Domestic Payment ");
		...
		public String getPaymentId() {
			return getResponseNodeStringByPath("Data.DomesticPaymentId");
	}
