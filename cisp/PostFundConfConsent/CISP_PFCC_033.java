...
public class CISP_PFCC_033 extends TestBase{	
	
	@Test
	public void m_CISP_PFCC_033() throws Throwable{	
		...
		TestLogger.logStep("[Step 2] : Checking the response through POST method with mandatory and optional fields");
