...
public class CISP_PFCC_008 extends TestBase
{
	@Test
	public void m_CISP_PFCC_008() throws Throwable{	
		...
		fundConfConsent.setHeadersString("Authorization:Bearer "+access_token.replace(access_token.substring(0, 2), "12"));
		fundConfConsent.submit();
		
		testVP.assertStringEquals(String.valueOf(fundConfConsent.getResponseStatusCode()),"401", 
				"Response Code is correct for fund Confiramtion Consent when invalid CCG access token is used in Fund Confirmation Consent Header");
