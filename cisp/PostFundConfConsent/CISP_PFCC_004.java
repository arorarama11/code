...
/**
 * Class Description : Verification of CMA compliance for POST Funds Confirmation Consent URI for incorrect Open Banking standard URI format with 'card-funds-confirmation-consents' instead of /funds-confirmation-consents
 * @author Alok Kumar
 *
 */
...
public class CISP_PFCC_004 extends TestBase
{
	@Test
	public void m_CISP_PFCC_004() throws Throwable{	
		...
		fundConfConsent.setBaseURL(apiConst.invalid_fc_endpoint);
		...
		testVP.assertStringEquals(String.valueOf(fundConfConsent.getResponseStatusCode()),"404", 
				"Response Code is correct for fund Confirmation Consent when the the url is invalid");
