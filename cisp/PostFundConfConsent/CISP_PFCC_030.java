...
/**
 * Class Description : Verification of SecondaryIdentification in the request payload
 * @author Alok Kumar
 *
 */
...
public class CISP_PFCC_030 extends TestBase
{
	@Test
	public void m_CISP_PFCC_030() throws Throwable{	
		...
		fundConfConsent.setSecondaryIdentification("fkhakfhaksfhkafhkajhfakfhkafhkahdfhhd");
		fundConfConsent.submit();
		
		testVP.assertStringEquals(String.valueOf(fundConfConsent.getResponseStatusCode()),"400", 
				"Response Code is correct for fund Confiramtion Consent when the value of SecondaryIdentification is invalid");
		...
		testVP.assertStringEquals(fundConfConsent.getResponseNodeStringByPath("Errors[0].Message"),"Error validating JSON. Error: - Expected max length 34", 
