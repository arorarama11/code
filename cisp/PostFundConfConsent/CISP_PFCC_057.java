...
public class CISP_PFCC_057 extends TestBase
{
	@Test
	public void m_CISP_PFCC_053() throws Throwable{	
		...
		testVP.assertStringEquals(String.valueOf(fundConfConsent.getResponseStatusCode()),"201", 
				"Response Code is correct for fund Confiramtion Consent when SchemeName = any.bank.scheme2 with valid identification");
