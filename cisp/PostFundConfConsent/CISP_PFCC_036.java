...
public class CISP_PFCC_036 extends TestBase{	
	
	@Test
	public void m_CISP_PFCC_036() throws Throwable{	
		...
		testVP.assertTrue(Misc.verifyDateTimeFormat(fundConfConsent.getResponseNodeStringByPath("Data.ExpirationDateTime").split("T")[0], "yyyy-MM-dd") && 
				Misc.verifyDateTimeFormat(fundConfConsent.getResponseNodeStringByPath("Data.ExpirationDateTime").split("T")[1], "HH:mm:ss+00:00"), 
				"ExpirationDateTime is as per expected format");
		TestLogger.logInfo("The ExpirationDateTime for the account request Id: "+fundConfConsent.getResponseNodeStringByPath("Data.ExpirationDateTime"));
