...
public class CISP_PFCC_044 extends TestBase
{
	@Test
	public void m_CISP_PFCC_044() throws Throwable{	
		...
		testVP.assertStringEquals(String.valueOf(fundConfConsent.getResponseStatusCode()),"201", 
				"Response Code is correct for fund Confiramtion Consent when the value of Identification is less than 35 char");
		TestLogger.logBlankLine();
