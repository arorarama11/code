...
public class CISP_PFCC_011 extends TestBase
{
	@Test
	public void m_CISP_PFCC_011() throws Throwable{	
		...
		fundConfConsent.setHeadersString("Authorization:Bearer "+apiConst.expired_cc_accesstoken);
		fundConfConsent.submit();
		
		testVP.assertStringEquals(String.valueOf(fundConfConsent.getResponseStatusCode()),"401", 
				"Response Code is correct for fund Confiramtion Consent when expired CCG token is used in Fund Confirmation Consent Header");
