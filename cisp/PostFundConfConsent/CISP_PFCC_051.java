...
/**
 * Class Description : Verification of the value of MANDATORY DebtorAccount/Identification field when SchemeName = UK.OBIE.Paym
 * @author Alok Kumar
 *
 */
...
public class CISP_PFCC_051 extends TestBase
{
	@Test
	public void m_CISP_PFCC_051() throws Throwable{	
		...
		testVP.assertStringEquals(String.valueOf(fundConfConsent.getResponseStatusCode()),"201", 
				"Response Code is correct for fund Confiramtion Consent when SchemeName = UK.OBIE.Paym with valid identification");
