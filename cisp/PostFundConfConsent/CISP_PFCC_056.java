...
/**
 * Class Description : Verification of the value of MANDATORY DebtorAccount/Identification field when SchemeName = any.bank.scheme1 with invalid identification
 * @author Alok Kumar
 *
 */
...
public class CISP_PFCC_056 extends TestBase
{
	@Test
	public void m_CISP_PFCC_054() throws Throwable{	
		...
		testVP.assertStringEquals(String.valueOf(fundConfConsent.getResponseStatusCode()),"400", 
				"Response Code is correct for fund Confiramtion Consent when SchemeName = any.bank.scheme1 with invalid identification");
