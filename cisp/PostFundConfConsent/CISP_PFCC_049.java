...
public class CISP_PFCC_049 extends TestBase
{
	@Test
	public void m_CISP_PFCC_049() throws Throwable{	
		...
		testVP.assertStringEquals(String.valueOf(fundConfConsent.getResponseStatusCode()),"201", 
				"Response Code is correct for fund Confiramtion Consent when SchemeName = UK.OBIE.PAN with valid identification");
		...
		testVP.assertStringEquals(String.valueOf(fundConfConsent.getResponseStatusCode()),"201", 
				"Response Code is correct for fund Confiramtion Consent when SchemeName = PAN with valid identification");
			TestLogger.logBlankLine();
