...
public class CISP_PFCC_038 extends TestBase
{
	@Test
	public void m_CISP_PFCC_038() throws Throwable{			
		...
		testVP.assertTrue(String.valueOf(fundConfConsent.getStatus()).equals("AwaitingAuthorisation"), 
				"The status in the response of Fund Confirmation Consent API is a valid value ");
		TestLogger.logBlankLine();
