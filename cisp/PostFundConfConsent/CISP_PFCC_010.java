...
public class CISP_PFCC_010 extends TestBase
{
	@Test
	public void m_CISP_PFCC_010() throws Throwable{	
		...
		testVP.assertStringEquals(String.valueOf(fundConfConsent.getResponseStatusCode()),"401", 
				"Response Code is correct for fund Confiramtion Consent when no authorization header is used in Fund Confirmation Consent");
