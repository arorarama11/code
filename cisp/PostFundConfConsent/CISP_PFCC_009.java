...
public class CISP_PFCC_009 extends TestBase
{
	@Test
	public void m_CISP_PFCC_009() throws Throwable{	
		...
		fundConfConsent.setHeadersString("Authorization:Bearer ");
		fundConfConsent.submit();
		
		testVP.assertStringEquals(String.valueOf(fundConfConsent.getResponseStatusCode()),"401", 
				"Response Code is correct for fund Confiramtion Consent when no CCG access token is used in Fund Confirmation Consent Header");
