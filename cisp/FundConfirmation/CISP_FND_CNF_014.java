...
/**
 * Class Description : Verification of Fund Confirmation request with decimal value of Amount field under InstructedAmount array
 * @author Alok Kumar
 *
 */
...
public class CISP_FND_CNF_014 extends TestBase
{
	@BeforeClass
	...
	@Test
	public void m_CISP_FND_CNF_014() throws Throwable{	
		...
		testVP.assertStringEquals(String.valueOf(fundConf.getResponseStatusCode()),"201", 
				"Response Code is correct for Fund Confiramtion Request when the value of Amount field is in decimal");
