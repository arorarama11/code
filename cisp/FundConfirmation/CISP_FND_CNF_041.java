...
/**
 * Class Description : Verification of Fund Confirmation response for valid value of x-fapi-interaction-id header
 * @author Alok Kumar
 *
 */
...
public class CISP_FND_CNF_041 extends TestBase{	
	...
	@Test
	public void m_CISP_FND_CNF_041() throws Throwable{
		
		TestLogger.logStep("[Step 1] : Verification of Fund Confirmation response for valid value of x-fapi-interaction-id header");
		...
		testVP.assertStringEquals(fundConf.getResponseHeader("x-fapi-interaction-id"),PropertyUtils.getProperty("inter_id"), 
