...
/**
 * Class Description : Verification of Fund Confirmation response for invalid value for x-fapi-financial-id header
 * @author Alok Kumar
 *
 */
...
public class CISP_FND_CNF_037 extends TestBase{	
	...
	@Test
	public void m_CISP_FND_CNF_037() throws Throwable{
		
		TestLogger.logStep("[Step 1] : Verification of Fund Confirmation response for invalid value for x-fapi-financial-id header");
		...
		fundConf.addHeaderEntry("x-fapi-financial-id", PropertyUtils.getProperty("fin_id")+"345!@");
		fundConf.submit();
	
		testVP.assertStringEquals(String.valueOf(fundConf.getResponseStatusCode()),"201", 
				"Response Code is correct for invalid value of header x-fapi-financial-id");
