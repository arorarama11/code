...
/**
 * Class Description : Verification of Fund Confirmation response for blank value for x-fapi-financial-id header
 * @author Alok Kumar
 *
 */
...
public class CISP_FND_CNF_038 extends TestBase{	
	...
	@Test
	public void m_CISP_FND_CNF_038() throws Throwable{
		
		TestLogger.logStep("[Step 1] : Verification of Fund Confirmation response for blank value for x-fapi-financial-id header");
		...
		fundConf.addHeaderEntry("x-fapi-financial-id", " ");
		fundConf.submit();
	
		testVP.assertStringEquals(String.valueOf(fundConf.getResponseStatusCode()),"201", 
				"Response Code is correct for blank value of header x-fapi-financial-id");
