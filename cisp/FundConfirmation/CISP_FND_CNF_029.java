...
/**
 * Class Description : Verification of Fund Confirmation response for Amount value should be same as passed in request
 * @author Alok Kumar
 *
 */
...
public class CISP_FND_CNF_029 extends TestBase{	
	...
	@Test
	public void m_CISP_FND_CNF_029() throws Throwable{	
		
		TestLogger.logStep("[Step 1] : Verification of Fund Confirmation response for Amount value should be same as passed in request");
		...
		testVP.assertStringEquals(String.valueOf(fundConf.getResponseValueByPath("Data.InstructedAmount.Amount")), "14.00", 
				"Value of Amount in response is same as that sent in request");
