...
/**
 * Class Description : Verification of Fund Confirmation request with incorrect HTTP method  
 * @author Alok Kumar
 *
 */
...
public class CISP_FND_CNF_005 extends TestBase{	
	...
	@Test
	public void m_CISP_FND_CNF_005() throws Throwable{	
		...
		fundConf.setMethod("PUT");
		fundConf.submit();
	
		testVP.assertStringEquals(String.valueOf(fundConf.getResponseStatusCode()),"405", 
				"Response Code is correct with invalid request method");
