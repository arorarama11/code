...
/**
 * Class Description : Verification of Fund Confirmation response having Self link 
 * @author Alok Kumar
 *
 */
...
public class CISP_FND_CNF_031 extends TestBase{	
	...
	@Test
	public void m_CISP_FND_CNF_031() throws Throwable{	
		...
		testVP.assertStringEquals(String.valueOf(fundConf.getResponseStatusCode()),"201", 
				"Response Code is correct with valid and mandatory headers");
		testVP.assertStringEquals(fundConf.getResponseNodeStringByPath("Links.Self"),fundConf.getURL()+"/"+fundConf.getFundsConfirmationId(), 
				"Self value is correct");
