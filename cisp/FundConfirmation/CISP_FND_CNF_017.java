...
/**
 * Class Description : Verification of Fund Confirmation request with value 0 for Amount field under InstructedAmount array
 * @author Alok Kumar
 *
 */
...
public class CISP_FND_CNF_017 extends TestBase
{
	@BeforeClass
	...
	@Test
	public void m_CISP_FND_CNF_017() throws Throwable{	
		...
		fundConf.setAmount("0.00");
		fundConf.submit();
	
		testVP.assertStringEquals(String.valueOf(fundConf.getResponseStatusCode()),"201", 
				"Response Code is correct for Fund Confiramtion Request when the value of Amount field is 0");
