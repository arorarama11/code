...
/**
 * Class Description : Verification of Fund Confirmation response for ConsentId with value should not be more than 128 char
 * @author Alok Kumar
 *
 */
...
public class CISP_FND_CNF_023 extends TestBase{	
	...
	@Test
	public void m_CISP_FND_CNF_023() throws Throwable{	
		
		TestLogger.logStep("[Step 1] : Verification of Fund Confirmation response for ConsentId with value should not be more than 128 char");
		...
		testVP.assertTrue(String.valueOf(fundConf.getResponseValueByPath("Data.ConsentId")).length()<=128, 
				"Length of ConsentId in response is within 128 characters");
