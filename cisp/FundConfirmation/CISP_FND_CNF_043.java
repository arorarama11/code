...
/**
 * Class Description : Verification of fundsAvailable flag when amount starts with 200
 * @author Alok Kumar
 *
 */
...
public class CISP_FND_CNF_043 extends TestBase{	
	...
	@Test
	public void m_CISP_FND_CNF_043() throws Throwable{
		...
		testVP.assertStringEquals(fundConf.getFundsAvailable(),"false", 
				"FundsAvailable correct when  when amount starts with 200");
