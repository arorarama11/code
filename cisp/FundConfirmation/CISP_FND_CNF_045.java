...
/**
 * Class Description : Verification of response when amount starts with 600
 * @author Alok Kumar
 *
 */
...
public class CISP_FND_CNF_045 extends TestBase{	
	...
	@Test
	public void m_CISP_FND_CNF_045() throws Throwable{
		...
		fundConf.setAmount("600.10");
		fundConf.submit();
	
		testVP.assertStringEquals(String.valueOf(fundConf.getResponseStatusCode()),"500", 
				"Response Code is correct when  when amount starts with 600");
