...
/**
 * Class Description : Verification of 'Status' field value - "Rejected"
 * @author Alok Kumar
 *
 */
...
public class CISP_GFCC_033 extends TestBase{	
	
	API_E2E_Utility util = new API_E2E_Utility();

	@Test
	public void m_CISP_GFCC_033() throws Throwable{	
		
		TestLogger.logStep("[Step 1] : Fund confirmation consent....");
		consentDetails = util.generateCISPConsent(false,true,false);	
		TestLogger.logBlankLine();		
				
		TestLogger.logStep("[Step 2] : Verification of 'Status' field value - Rejected");
		...
		testVP.assertStringEquals(String.valueOf(getFundConfConsent.getResponseValueByPath("Data.Status")), "Rejected", 
				"Status field value - Rejected verified");
