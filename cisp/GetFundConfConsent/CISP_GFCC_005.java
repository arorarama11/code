...
/**
 * Class Description : Verification of Verification of CMA compliance for GET Funds Confirmation Consent URI for old version i.e. 1.1 
 * @author Alok Kumar
 *
 */
...
public class CISP_GFCC_005 extends TestBase{	
	
	API_E2E_Utility util = new API_E2E_Utility();
	
	@Test
	public void m_CISP_GFCC_005() throws Throwable{	
		...
		getFundConfConsent.setBaseURL(apiConst.invalid_cma_fc_endpoint+"/"+consentDetails.get("consentId"));
		...
		testVP.assertStringEquals(String.valueOf(getFundConfConsent.getResponseStatusCode()),"404", 
				"Response Code is correct for incorrect version of Get fund Confirmation Consent request");
		TestLogger.logBlankLine();
