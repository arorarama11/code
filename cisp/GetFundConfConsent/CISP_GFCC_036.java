...
/**
 * Class Description : Verification of Identification in the response field value 
 * @author Alok Kumar
 *
 */
...
public class CISP_GFCC_036 extends TestBase{	
	
	API_E2E_Utility util = new API_E2E_Utility();
	
	@Test
	public void m_CISP_GFCC_036() throws Throwable{	
		
		TestLogger.logStep("[Step 1] : Fund confirmation consent....");
		consentDetails = util.generateCISPConsent(true,false,false);	
		TestLogger.logBlankLine();
		
		TestLogger.logStep("[Step 2] : Verification of Identification field in the response");
	    ...
	    testVP.assertStringEquals(getFundConfConsent.getResponseNodeStringByPath("Data.DebtorAccount.Identification"),
	    		consentDetails.get("identification"), "Identification matches correctly");	
