...
public class CISP_GFCC_028 extends TestBase{	
	
	API_E2E_Utility util = new API_E2E_Utility();
	
	@Test
	public void m_CISP_GFCC_028() throws Throwable{	
		...
		testVP.assertTrue(Misc.verifyDateTimeFormat(getFundConfConsent.getResponseNodeStringByPath("Data.CreationDateTime").split("T")[0], "yyyy-MM-dd") && 
				Misc.verifyDateTimeFormat(getFundConfConsent.getResponseNodeStringByPath("Data.CreationDateTime").split("T")[1], "HH:mm:ss+00:00"), 
				"CreationDateTime is as per expected format");
		TestLogger.logInfo("The CreationDateTime for the account request Id: "+getFundConfConsent.getResponseNodeStringByPath("Data.CreationDateTime"));
