...
public class CISP_GFCC_006 extends TestBase{	
	
	API_E2E_Utility util = new API_E2E_Utility();
	
	@Test
	public void m_CISP_GFCC_006() throws Throwable{	
		...
		testVP.assertStringEquals(String.valueOf(getFundConfConsent.getResponseStatusCode()),"200", 
				"Response Code is correct with mandatory and optional field of Get fund Confirmation Consent request");
		TestLogger.logBlankLine();
