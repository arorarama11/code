...
/**
 * Class Description : Verification of the Invalid value of MANDATORY CreditorAccount/Identification field when SchemeName = UK.OBIE.SortCodeAccountNumber/SortCodeAccountNumber
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_096 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_96() throws Throwable{	
		...
		paymentConsent.setCrAccountSchemeName("UK.OBIE.SortCodeAccountNumber");
		paymentConsent.setCrAccountIdentification("A21243######");
