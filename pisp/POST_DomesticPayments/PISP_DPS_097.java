...
public class PISP_DPS_097 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_97() throws Throwable{	
		...
		paymentConsent.setCrAccountSchemeName("UK.OBIE.IBAN");
		paymentConsent.setCrAccountIdentification("IE85BOFI90120412345679");
		...
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.CreditorAccount.SchemeName"), "UK.OBIE.IBAN", 
				"SchemeName field value is correct");
		
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.CreditorAccount.Identification"), "IE85BOFI90120412345679", 
