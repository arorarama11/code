...
public class PISP_DPS_066 extends TestBase {

	API_E2E_Utility apiUtility = new API_E2E_Utility();

	@Test
	public void m_PISP_DPS_066() throws Throwable {
		...
		paymentConsent.setDrAccountSchemeName("UK.OBIE.IBAN12465234253816249274023482hdsghxdzjhvxzxk");
		paymentConsent.submit();

		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseStatusCode()),"400",
				"Response Code is correct for Domestic Payment URI when DebtorAccount SchemeName is more than 40 characters");
