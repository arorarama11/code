...
/**
 * Class Description : Verification of the Invalid value of MANDATORY DebtorAccount/Identification field when SchemeName = any.bank.Scheme1
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_081 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_81() throws Throwable{	
		...
		paymentConsent.setDrAccountSchemeName("any.bank.scheme1");
		paymentConsent.setDrAccountIdentification("scheme12333");
