...
public class PISP_DPS_122 extends TestBase{	
	
	API_E2E_Utility apiUtility = new API_E2E_Utility();
	
	@Test
	public void m_PISP_DPS_122() throws Throwable{	
       ...
       TestLogger.logStep("[Step 1] : Create Domestic Payment Consent");
		...
		paymentConsent.setCrStreetName("ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ12345678X");
