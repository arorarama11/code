...
/**
 * Class Description : Verification of the status when MANDATORY Data/Initiation/CreditorAccount block haven't sent
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_087 extends TestBase {	
	
	API_E2E_Utility apiUtility = new API_E2E_Utility();
	
	@Test
	public void m_PISP_DPS_87() throws Throwable{	
       ...
       TestLogger.logStep("[Step 2] : Verification of the values into MANDATORY Data/Initiation/CreditorAccount block");
		...
		paymentConsent.removeCreditorAccount();
		paymentConsent.submit();
		
		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseStatusCode()),"400", 
				"Response Code is correct for Domestic Payment URI when CreditorAccount block haven't sent");
		...
		testVP.assertTrue(paymentConsent.getResponseNodeStringByPath("Errors[0].Message").equals("Error validating JSON. Error: - Missing required field \"CreditorAccount\""), 
