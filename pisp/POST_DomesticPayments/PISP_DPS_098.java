...
/**
 * Class Description : Verification of the Invalid value of MANDATORY CreditorAccount/Identification field when SchemeName = UK.OBIE.IBAN/IBAN
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_098 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_98() throws Throwable{	
		...
		paymentConsent.setCrAccountSchemeName("UK.OBIE.IBAN");
		paymentConsent.setCrAccountIdentification("IE85BOFI90120412345679AAAAAAA@@@@@@@");
