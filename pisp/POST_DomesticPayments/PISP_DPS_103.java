...
/**
 * Class Description : Verification of the value of MANDATORY CreditorAccount/Identification field when SchemeName = UK.OBIE.BBAN
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_103 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_103() throws Throwable{	
		...
		paymentConsent.setCrAccountSchemeName("UK.OBIE.BBAN");
		paymentConsent.setCrAccountIdentification("ABCD12345678901234");
		...
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.CreditorAccount.SchemeName"), "UK.OBIE.BBAN", 
				"SchemeName field value is correct");
		
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.CreditorAccount.Identification"), "ABCD12345678901234", 
