...
public class PISP_DPS_184 extends TestBase{	
	API_E2E_Utility apiUtility = new API_E2E_Utility();
	@Test
	public void m_PISP_DPS_184() throws Throwable{	
		...
		testVP.assertTrue(String.valueOf(paymentConsent.getResponseValueByPath("Data.Charges[0].Amount.Currency")).length()==3, 
				"Amount under Charges block consists of Currency field which is equal to 3 characters");
