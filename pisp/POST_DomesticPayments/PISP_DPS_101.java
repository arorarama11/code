...
/**
 * Class Description : Verification of the value of MANDATORY CreditorAccount/Identification field when SchemeName = UK.OBIE.Paym
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_101 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_101() throws Throwable{	
		...
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.CreditorAccount.SchemeName"), "UK.OBIE.Paym", 
				"SchemeName field value is correct");
		
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.CreditorAccount.Identification"), "11223344552222", 
