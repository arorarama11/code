...
/**
 * Class Description : Verification of the values into MANDATORY Data/Initiation/InstructedAmount/Amount field starts with 400 for Currency as EUR/GBP
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_229 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_229() throws Throwable{	
		...
		paymentConsent.setAmount("400.12");
		...
		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseStatusCode()),"201",
				"Response Code is correct for Domestic Payment URI when InstructedAmount/Amount as 400");

		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseValueByPath("Data.Status")), "Pending",
				"Mandatory field Status as Pending");
		
		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseValueByPath("Data.MultiAuthorisation.Status")),"AwaitingFurtherAuthorisation",
				"Mandatory field MultiAuthorisation is present and status as AwaitingFurtherAuthorisation");
