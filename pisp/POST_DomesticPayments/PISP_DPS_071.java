...
/**
 * Class Description : Verification of the Invalid value of MANDATORY DebtorAccount/Identification field when SchemeName = UK.OBIE.SortCodeAccountNumber/SortCodeAccountNumber
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_071 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_71() throws Throwable{	
		...
		paymentConsent.setDrAccountSchemeName("UK.OBIE.SortCodeAccountNumber");
		paymentConsent.setDrAccountIdentification("A21243######");
