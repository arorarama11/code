...
/**
 * Class Description : Verification of the request without x-fapi-financial-id key-value pair into header
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_022 extends TestBase{	
	
	API_E2E_Utility apiUtility = new API_E2E_Utility();
	
	@Test
	public void m_PISP_DPS_022() throws Throwable{	
		...
		testVP.assertStringEquals(String.valueOf(restRequest.getResponseStatusCode()),"201", 
				"Response Code is correct for Domestic Payment Consent when request without x-fapi-financial-id key-value pair into header");
