...
/**
 * Class Description : Verification of the values into MANDATORY ChargeBearer field where Request has sent successfully and returned a HTTP Code 201 Created if FirstPaymentAmount/Currency is INR
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_236 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_236() throws Throwable{	
		...
		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseStatusCode()),"201",
				"Response Code is correct for Domestic Payment URI when InstructedAmount/Amount/Currency as INR");
		...
		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseValueByPath("Data.Charges[0].ChargeBearer")), "BorneByDebtor",
				"Mandatory field ChargeBearer as BorneByDebtor");
