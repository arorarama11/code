...
/**
 * Class Description : Verification of the values into MANDATORY ChargeBearer field as FollowingServiceLevel if FirstPaymentAmount/Currency is EUR
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_237 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_237() throws Throwable{	
		...
		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseStatusCode()),"201",
				"Response Code is correct for Domestic Payment URI when InstructedAmount/Amount/Currency as EUR");

		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseValueByPath("Data.Charges[0].ChargeBearer")), "FollowingServiceLevel",
				"Mandatory field ChargeBearer as FollowingServiceLevel");
