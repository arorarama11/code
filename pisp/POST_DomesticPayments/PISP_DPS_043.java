...
public class PISP_DPS_043 extends TestBase{	
	
	API_E2E_Utility apiUtility = new API_E2E_Utility();
	
	@Test
	public void m_PISP_DPS_043() throws Throwable{	
			...
			paymentConsent.setEndToEndIdentification("FRESCO.21302.GFX.20FRESCO.21302.GF");
		    ...
		    testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseStatusCode()),"201", 
				"Response Code is correct for Domestic Payment URL for EndToEndIdentification fields which is equal to 35 characters");
