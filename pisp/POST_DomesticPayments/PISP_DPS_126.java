...
/**
 * Class Description : Verification of the value of OPTIONAL CreditorPostalAddress/PostCode field having length variation
...
public class PISP_DPS_126 extends TestBase{	
	
	API_E2E_Utility apiUtility = new API_E2E_Utility();

	@Test
	public void m_PISP_DPS_126() throws Throwable{	
		...
		paymentConsent.setCrPostCode("ABCDEFGHIJ123456AAA");
		paymentConsent.setConsentId(consentDetails.get("consentId"));
		paymentConsent.submit();
		
		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseStatusCode()),"400", 
		"Response Code is correct for Domestic Payment URL for PostCode fields which is in between 1-16 characters");		
