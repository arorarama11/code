...
public class PISP_DPS_139 extends TestBase{	
	
	API_E2E_Utility apiUtility = new API_E2E_Utility();
	
	@Test
	public void m_PISP_DPS_139() throws Throwable{	
...
TestLogger.logStep("[Step 1] : Create Domestic Payment Consent");
		...
		paymentConsent.setRemittanceReference("ABCDEFGHIJKLMNOPQRSTUVWXYZ12345678AAA");
