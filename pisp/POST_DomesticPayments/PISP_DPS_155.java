...
public class PISP_DPS_155 extends TestBase{	
	
	API_E2E_Utility apiUtility = new API_E2E_Utility();

	@Test
	public void m_PISP_DPS_155() throws Throwable{	
		...
		paymentConsent.setRiskAddressPostCode("ABCDEF 12345678945785");
        paymentConsent.setConsentId(consentDetails.get("consentId"));
		paymentConsent.submit();
		
		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseStatusCode()),"400", 
		"Response Code is correct for Domestic Payment URL for PostCode fields having length in between 1-16 characters");		
