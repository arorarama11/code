...
public class PISP_DPS_055 extends TestBase{	
	
	API_E2E_Utility apiUtility = new API_E2E_Utility();
	
	@Test
	public void m_PISP_DPS_055() throws Throwable{	
...
TestLogger.logStep("[Step 1] : Create Domestic Payment Consent");
		...
		TestLogger.logStep("[Step 2] : POST Domestic Payment Submission");	
			...
			paymentConsent.setAmount("3123456789012111.1234511111");
		    ...
		    testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseStatusCode()),"400", 
					"Response Code is correct for Domestic Payment URI when MANDATORY InstructedAmount/Amount field having both values more than 13 non-decimal and 5 decimals");
			...
			testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Errors[0].Message"), "Error validating JSON. Error: - Invalid value '3123456789012111.1234511111'. Expected ^\\d{1,13}\\.\\d{1,5}$", "Error Message are matched");
