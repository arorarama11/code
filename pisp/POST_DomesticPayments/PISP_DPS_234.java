...
/**
 * Class Description : Verification of the values into MANDATORY Data/Initiation/InstructedAmount/Amount field starts with 900 for Currency as EUR/GBP
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_234 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_234() throws Throwable{	
		...
		paymentConsent.setAmount("900.12");
		...
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Errors[0].ErrorCode"), "UK.OBIE.Rules.AfterCutOffDateTime", 
				"Error code for the response is correct i.e. '"+paymentConsent.getResponseNodeStringByPath("Errors[0].ErrorCode")+"'");
		
		testVP.assertTrue(paymentConsent.getResponseNodeStringByPath("Errors[0].Message").equals("SandBox AfterCutOffDate Mocked Error"), 
