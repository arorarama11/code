...
public class PISP_DPS_231 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_231() throws Throwable{	
		...
		paymentConsent.setAmount("600.12");
		...
		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseStatusCode()),"500",
				"Response Code is correct for Domestic Payment URI when InstructedAmount/Amount as 600");
