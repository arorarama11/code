...
/**
 * Class Description : Verification of the values into MANDATORY ChargeBearer field as Shared if FirstPaymentAmount/Currency is GBP
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_238 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_238() throws Throwable{	
		...
		paymentConsent.setCurrency("GBP");
		...
		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseStatusCode()),"201",
				"Response Code is correct for Domestic Payment URI when InstructedAmount/Amount/Currency as GBP");

		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseValueByPath("Data.Charges[0].ChargeBearer")), "Shared",
				"Mandatory field ChargeBearer as Shared");
