...
public class PISP_DPS_180 extends TestBase{	
	API_E2E_Utility apiUtility = new API_E2E_Utility();
	@Test
	public void m_PISP_DPS_180() throws Throwable{	
		...
		testVP.assertTrue(paymentConsent.getResponseValueByPath("Data.Charges[0].ChargeBearer").equals("FollowingServiceLevel") 
				|| paymentConsent.getResponseValueByPath("Data.Charges[0].ChargeBearer").equals("BorneByCreditor") 
				...
				"ChargeBearer under Charges block is correct i.e. "+paymentConsent.getResponseValueByPath("Data.Charges[0].ChargeBearer"));
