...
public class PISP_DPS_163 extends TestBase{	
	
	API_E2E_Utility apiUtility = new API_E2E_Utility();

	@Test
	public void m_PISP_DPS_163() throws Throwable{	
		...
		paymentConsent.setRiskCountry("USB");
		...
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Errors.Message"), "[Error validating JSON. Error: - Invalid value 'USB'. Expected ^[A-Z]{2,2}$]", "Error Message are matched");
