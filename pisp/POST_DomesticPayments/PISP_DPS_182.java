...
public class PISP_DPS_182 extends TestBase{	
	API_E2E_Utility apiUtility = new API_E2E_Utility();
	@Test
	public void m_PISP_DPS_182() throws Throwable{	
		...
		testVP.assertTrue(paymentConsent.getResponseValueByPath("Data.Charges[0].Amount")!=null,
				"Amount block under Charges block is present and is not null");
		
		testVP.assertTrue(!(paymentConsent.getResponseNodeStringByPath("Data.Charges[0].Amount.Amount")).isEmpty(),
				"Amount under Charges block consists of Amount field");
		
		testVP.assertTrue(!(paymentConsent.getResponseNodeStringByPath("Data.Charges[0].Amount.Currency")).isEmpty(),
