...
/**
 * Class Description : Verification of the values into MANDATORY Data/Initiation/InstructedAmount/Amount field starts with 500 for Currency as EUR/GBP
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_230 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_230() throws Throwable{	
		...
		paymentConsent.setAmount("500.12");
		...
		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseStatusCode()),"201",
				"Response Code is correct for Domestic Payment URI when InstructedAmount/Amount as 500");
		...
		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseValueByPath("Data.MultiAuthorisation.Status")),"Rejected",
				"Mandatory field MultiAuthorisation is present and status as Rejected");
