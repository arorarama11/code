...
/**
 * Class Description : Verification of the Invalid value of MANDATORY CreditorAccount/Identification field when SchemeName = UK.OBIE.BBAN
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_104 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_104() throws Throwable{	
		...
		paymentConsent.setCrAccountSchemeName("UK.OBIE.BBAN");
		paymentConsent.setCrAccountIdentification("ABCD12345678901234!2233!");
