...
/**
 * Class Description : Verification of the value of OPTIONAL CreditorPostalAddress/SubDepartment field having length variation
...
public class PISP_DPS_120 extends TestBase{	
	
	API_E2E_Utility apiUtility = new API_E2E_Utility();
	
	@Test
	public void m_PISP_DPS_120() throws Throwable{	
		...
		paymentConsent.setCrSubDepartment("ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ12345678X");
		paymentConsent.submit();
			
		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseStatusCode()),"400", 
					"unexpected Sub department length");
