...
public class PISP_DPS_189 extends TestBase{	
	API_E2E_Utility apiUtility = new API_E2E_Utility();
	@Test
	public void m_PISP_DPS_189() throws Throwable{	
		...
		testVP.assertTrue(paymentConsent.getResponseValueByPath("Data.Initiation.InstructedAmount.Amount")!=null, 
				"InstructedAmount field under Initiation is present and is not null");
		
		testVP.assertTrue(!(paymentConsent.getResponseNodeStringByPath("Data.Initiation.InstructedAmount.Amount")).isEmpty(), 
				"InstructedAmount field under Initiation consists of Amount field");
		
		testVP.assertTrue(!(paymentConsent.getResponseNodeStringByPath("Data.Initiation.InstructedAmount.Currency")).isEmpty(), 
