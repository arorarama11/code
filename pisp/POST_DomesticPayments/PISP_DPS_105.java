...
/**
 * Class Description : Verification of the value of MANDATORY CreditorAccount/Identification field when SchemeName = any.bank.scheme1
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_105 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_105() throws Throwable{	
		...
		paymentConsent.setCrAccountSchemeName("any.bank.scheme1");
		paymentConsent.setCrAccountIdentification("scheme1");
		...
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.CreditorAccount.SchemeName"), "any.bank.scheme1", 
				"SchemeName field value is correct");
		
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.CreditorAccount.Identification"), "scheme1", 
