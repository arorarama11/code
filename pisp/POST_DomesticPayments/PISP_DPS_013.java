...
/**
 * Class Description : All the above steps would remains same where different request payload has been sent into BODY with same x-idempotency-key by same TPP within 24 hrs.
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_013 extends TestBase {	
	
	API_E2E_Utility apiUtility = new API_E2E_Utility();
	
	@Test
	public void m_PISP_DPC_013() throws Throwable{	
		...
		testVP.assertStringEquals(String.valueOf(paymentConsent.getResponseStatusCode()),"400", 
				"Response Code is correct for Domestic Payment when x-idempotency-key value is same i.e. "+idemPotencyKey+" and payload is different");
