...
public class PISP_DPS_082 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_82() throws Throwable{	
		...
		paymentConsent.setDrAccountSchemeName("any.bank.scheme2");
		paymentConsent.setDrAccountIdentification("scheme2");
		...
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.DebtorAccount.SchemeName"), "any.bank.scheme2", 
				"SchemeName field value is correct");
		
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.DebtorAccount.Identification"), "scheme2", 
