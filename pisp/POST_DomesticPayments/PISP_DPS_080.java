...
public class PISP_DPS_080 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_80() throws Throwable{	
		...
		paymentConsent.setDrAccountSchemeName("any.bank.scheme1");
		paymentConsent.setDrAccountIdentification("scheme1");
		...
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.DebtorAccount.SchemeName"), "any.bank.scheme1", 
				"SchemeName field value is correct");
		
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.DebtorAccount.Identification"), "scheme1", 
