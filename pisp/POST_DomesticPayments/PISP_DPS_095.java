...
public class PISP_DPS_095 extends TestBase {	
	...
	public void m_PISP_DPS_95() throws Throwable{	
		...
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.CreditorAccount.SchemeName"), "UK.OBIE.SortCodeAccountNumber", 
				"SchemeName field value is correct");
		
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.CreditorAccount.Identification"), "12345678901234", 
