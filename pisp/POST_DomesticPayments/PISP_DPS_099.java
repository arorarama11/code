...
/**
 * Class Description : Verification of the value of MANDATORY CreditorAccount/Identification field when SchemeName = UK.OBIE.PAN/PAN
 * @author Rama Arora
 *
 */
...
public class PISP_DPS_099 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_99() throws Throwable{	
		...
		paymentConsent.setCrAccountSchemeName("UK.OBIE.PAN");
		paymentConsent.setCrAccountIdentification("123456789011211314");
		...
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.CreditorAccount.SchemeName"), "UK.OBIE.PAN", 
				"SchemeName field value is correct");
		
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.CreditorAccount.Identification"), "123456789011211314", 
