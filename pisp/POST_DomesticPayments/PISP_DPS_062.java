...
public class PISP_DPS_062 extends TestBase{	
	
	API_E2E_Utility apiUtility = new API_E2E_Utility();
	
	@Test
	public void m_PISP_DPS_062() throws Throwable{	
		...
		TestLogger.logStep("[Step 2] : POST Domestic Payment Submission");	
		    ...
		    TestLogger.logStep("[Step 3] : Verification of the values into OPTIONAL Data/Initiation/DebtorAccount block");
