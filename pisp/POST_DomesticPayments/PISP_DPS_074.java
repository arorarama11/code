...
public class PISP_DPS_074 extends TestBase {	
	
	@Test
	public void m_PISP_DPS_74() throws Throwable{	
		...
		paymentConsent.setDrAccountSchemeName("UK.OBIE.PAN");
		paymentConsent.setDrAccountIdentification("123456789011211314");
		...
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.DebtorAccount.SchemeName"), "UK.OBIE.PAN", 
				"SchemeName field value is correct");
		
		testVP.assertStringEquals(paymentConsent.getResponseNodeStringByPath("Data.Initiation.DebtorAccount.Identification"), "123456789011211314", 
