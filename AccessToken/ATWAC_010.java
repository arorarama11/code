...
/**
 * Class Description : Generation of oAuth Access Token URI when TPP has provided invalid value of grant_type parameter.  
 * @author Alok Kumar
 *
 */
...
public class ATWAC_010 extends TestBase{	
	

	API_E2E_Utility apiUtil = new API_E2E_Utility();
	
	@Test
	public void m_ATWAC_010() throws Throwable{	
		...
		accesstoken.setGrantType("authorization_code_test");
		accesstoken.submit();
		
		testVP.assertStringEquals(String.valueOf(accesstoken.getResponseStatusCode()),"400", 
				"Response Code is correct for get access token request with invalid Grant Type");	
